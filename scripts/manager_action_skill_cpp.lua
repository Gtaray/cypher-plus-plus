...
function modRoll(rSource, rTarget, rRoll)
	...
	local nEffortEffect = EffectManagerCPP.getEffectsBonusByType(rSource, { "EFFORT", "EFF" }, { sStat, "skill", sSkill }, rTarget);
	local nMaxEffort = ActorManagerCPP.getMaxEffort(rSource, sStat, "skill");
